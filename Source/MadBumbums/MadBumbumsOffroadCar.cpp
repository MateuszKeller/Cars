...
#include "MadBumbumsOffroadCar.h"
#include "MadBumbumsOffroadWheelFront.h"
#include "MadBumbumsOffroadWheelRear.h"
...
AMadBumbumsOffroadCar::AMadBumbumsOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UMadBumbumsOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UMadBumbumsOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UMadBumbumsOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UMadBumbumsOffroadWheelRear::StaticClass();
