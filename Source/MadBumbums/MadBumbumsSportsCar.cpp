...
#include "MadBumbumsSportsCar.h"
#include "MadBumbumsSportsWheelFront.h"
...
AMadBumbumsSportsCar::AMadBumbumsSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UMadBumbumsSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UMadBumbumsSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UMadBumbumsSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UMadBumbumsSportsWheelRear::StaticClass();
